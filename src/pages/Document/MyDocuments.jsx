      ...
      <div className="container-fluid px-4">
        <div className="row gx-4">
          {docType.map((ele, index) => {
            return (
              <div className="col col-sm-12 col-md-4 col-lg-3 col-xl-3" onClick={() => {
          ...
          <div className="col col-sm-12 col-md-4 col-lg-3 col-xl-3 ">
            <div className="folder-container">
              <img className="folder-img" src={folderImg} alt="" />
              <p className="folder-name fs-5">Purchase Orders</p>
            </div>
          </div>
